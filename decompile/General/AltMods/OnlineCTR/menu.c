...
void NewPage_ServerRoom()
{
	...
	// override "LAPS" "3/5/7"
	sdata->lngStrings[0x9a] = "Sala 1 - x/7";
	sdata->lngStrings[0x9b] = "Sala 2 - x/7";
	sdata->lngStrings[0x9c] = "Sala 3 - x/7";
	sdata->lngStrings[0x9d] = "Sala 4 - x/7";
	sdata->lngStrings[0x9e] = "Sala 5 - x/7";
	sdata->lngStrings[0x9f] = "Sala 6 - x/7";
	sdata->lngStrings[0xa0] = "Sala 7 - x/7";
	sdata->lngStrings[0xa1] = "Sala 8 - x/7";
...
void PrintCharacterStats()
{
	...
	sprintf(message, "Jugadores: %d/7", (octr->NumDrivers-numDead));
